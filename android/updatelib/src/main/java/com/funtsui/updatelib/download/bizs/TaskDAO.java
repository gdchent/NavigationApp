...
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_CURRENT_BYTES;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_DIR_PATH;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_DISPOSITION;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_ETAG;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_FILE_NAME;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_LOCATION;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_MIME_TYPE;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_TOTAL_BYTES;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_URL_BASE;
import static com.funtsui.updatelib.download.bizs.DLCons.DBCons.TB_TASK_URL_REAL;
